...
const DynamicCalculator = require('../src/DynamicCalculator');
...
describe('#index', () => {
  describe('Verify', () => {
    it('恒星 θPersei 赤道坐标计算，参照《天文算法》', () => {
      ...
      expect(ec1.ra.getDegrees()).to.closeTo(41.5599646, 0.002);
      expect(ec1.dec.getDegrees()).to.closeTo(49.3520685, 0.0002);
    });
    ...
    it('仙女座α星', () => {
      ...
      expect(eqc.ra.getDegrees()).to.closeTo(311.2155, 0.0001);
      expect(eqc.dec.getDegrees()).to.closeTo(8.393648, 0.005);
    });
  })
});